...
var DepositScene = (function (_super) {
    ...
    __decorate([
        property(cc.Button)
    ], DepositScene.prototype, "btn_back", void 0);
    __decorate([
        property(cc.Button)
    ], DepositScene.prototype, "btn_continue", void 0);
    __decorate([
        property(cc.Button)
    ], DepositScene.prototype, "btn_request_desposit", void 0);
    __decorate([
        property(cc.Button)
    ], DepositScene.prototype, "btn_desposit_record", void 0);
    DepositScene = __decorate([
        ccclass()
    ], DepositScene);
    return DepositScene;
}(cc.Component));
